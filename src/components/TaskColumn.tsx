...
import { useCreateTaskMutation } from '../app/api/task';
import type { ITask, TaskPriority } from '../app/api/task';
...
export const TaskColumn: React.FC<TaskColumnProps> = ({
  ...
  return (
    <div className="w-full max-w-sm rounded-2xl  border border-[#1e232d] p-5 shadow-sm text-white flex flex-col justify-between min-h-[460px]">
